...
\title{XCPC Algorithm Contest Template}
\author{Flight of the Bamboo Cutter}
\date{\today}
\titleformat{\chapter}[display]{\Huge\bfseries}{第~\thechapter~章}{1em}{}

\setmainfont[BoldFont={Rockwell}]{Rockwell}
\setsansfont[BoldFont={Courier New}]{Courier New}
\setmonofont[Scale=1]{Consolas}  % scale is needed for visual balance between Chinese and English
